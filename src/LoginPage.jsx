...
const LoginPage = () => {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      const { data, error } = await supabase.auth.signInWithOAuth({
        provider: "google",
        options: {
          redirectTo: "https://sungkum.vercel.app/auth-callback", // ✅ Ensure this is in Supabase Redirect URLs
          flow: "pkce",
        },
      });
  ...
  const handleLogout = async () => {
    ...
    setUser(null);
    window.location.href = "/login"; // ✅ Full page refresh to clear session
  };
